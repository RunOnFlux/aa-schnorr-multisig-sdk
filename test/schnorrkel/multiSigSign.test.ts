...
describe("testing multiSigSign", () => {
  ...
  it("should requires two public keys or more", () => {
    ...
    expect(() => schnorrkel.multiSigSign(keyPair.privateKey, msg, publicKeys, [publicNonces])).toThrow(
  ...
  it("should requires nonces", () => {
    ...
    expect(() => schnorrkel.multiSigSign(keyPairOne.privateKey, msg, publicKeys, [])).toThrow("Nonces should be exchanged before signing")
  })
